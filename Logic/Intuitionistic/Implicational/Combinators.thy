...
theory Combinators
  imports "./Implicational_Intuitionistic_Logic"
begin
...
interpretation Combinator_Implicational_Intuitionistic_Logic:
  Implicational_Intuitionistic_Logic "\<lambda> \<phi>. \<exists> X. X \<Colon> \<phi>" "(\<^bold>\<Rightarrow>)"
...
primrec (in Implicational_Intuitionistic_Logic) Simple_Type_interpretation
...
lemma (in Implicational_Intuitionistic_Logic) Curry_Howard_correspondence:
