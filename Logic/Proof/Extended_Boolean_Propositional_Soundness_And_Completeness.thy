theory Extended_Boolean_Propositional_Soundness_And_Completeness
  imports Intuitionistic_Logic
begin

datatype 'a Extended_Boolean_Propositional_Formula =
      Falsum                                            ("\<^bold>\<bottom>")
    | Verum                                             ("\<^bold>\<top>")
    | Proposition 'a
    | Negation "'a Extended_Boolean_Propositional_Formula"      ("\<^bold>\<sim>")
    | Conjunction "'a Extended_Boolean_Propositional_Formula" 
                  "'a Extended_Boolean_Propositional_Formula"   (infixr "\<^bold>\<sqinter>" 67)
    | Disjunction "'a Extended_Boolean_Propositional_Formula"
                  "'a Extended_Boolean_Propositional_Formula"   (infixr "\<^bold>\<squnion>" 68)
    | Implication "'a Extended_Boolean_Propositional_Formula" 
                  "'a Extended_Boolean_Propositional_Formula"   (infixr "\<^bold>\<rightarrow>" 70)
    | Biconditional "'a Extended_Boolean_Propositional_Formula" 
                    "'a Extended_Boolean_Propositional_Formula" (infixr "\<^bold>\<leftrightarrow>" 75)
                  
named_theorems Extended_Boolean_Propositional_Calculus 
               "Rules for the Extended Propositional Calculus"
                  
inductive Extended_Boolean_Propositional_Calculus 
          :: "'a Extended_Boolean_Propositional_Formula \<Rightarrow> bool"  ("\<turnstile>\<^sub>P\<^sub>R\<^sub>O\<^sub>P _" [60] 55)
  where
       Axiom_1 [Extended_Boolean_Propositional_Calculus]: 
         "\<turnstile>\<^sub>P\<^sub>R\<^sub>O\<^sub>P \<phi> \<^bold>\<rightarrow> \<psi> \<^bold>\<rightarrow> \<phi>"
    |  Axiom_2 [Extended_Boolean_Propositional_Calculus]: 
    ...
    |  Biconditional_Introduction [Extended_Boolean_Propositional_Calculus]: 
    ...
    |  Biconditional_Left_Elimination [Extended_Boolean_Propositional_Calculus]: 
        "\<turnstile>\<^sub>P\<^sub>R\<^sub>O\<^sub>P (\<phi> \<^bold>\<leftrightarrow> \<psi>) \<^bold>\<rightarrow> \<phi> \<^bold>\<rightarrow> \<psi>"
    |  Biconditional_Right_Elimination [Extended_Boolean_Propositional_Calculus]: 
        "\<turnstile>\<^sub>P\<^sub>R\<^sub>O\<^sub>P (\<phi> \<^bold>\<leftrightarrow> \<psi>) \<^bold>\<rightarrow> \<psi> \<^bold>\<rightarrow> \<phi>"

instantiation Extended_Boolean_Propositional_Formula :: (type) Extended_Boolean_Propositional_Logic
begin
...
instance 
by standard ((simp add: Extended_Boolean_Propositional_Calculus)+, 
             meson Extended_Boolean_Propositional_Calculus) 
end

primrec Extended_Boolean_Propositional_Semantics :: 
  "'a set \<Rightarrow> 'a Extended_Boolean_Propositional_Formula \<Rightarrow> bool" (infix "\<Turnstile>\<^sub>P\<^sub>R\<^sub>O\<^sub>P" 65)
  where
...
theorem Extended_Boolean_Propositional_Calculus_Soundness:
  "\<turnstile>\<^sub>P\<^sub>R\<^sub>O\<^sub>P \<phi> \<Longrightarrow> \<MM> \<Turnstile>\<^sub>P\<^sub>R\<^sub>O\<^sub>P \<phi>"
  by (induct rule: Extended_Boolean_Propositional_Calculus.induct, simp+, blast, simp+)
  
definition Strong_Extended_Boolean_Propositional_Deduction :: 
  "'a Extended_Boolean_Propositional_Formula set \<Rightarrow> 'a Extended_Boolean_Propositional_Formula \<Rightarrow> bool"  
  (infix "\<tturnstile>\<^sub>P\<^sub>R\<^sub>O\<^sub>P" 65)
  where
    [simp]: "\<Gamma> \<tturnstile>\<^sub>P\<^sub>R\<^sub>O\<^sub>P \<phi> \<equiv> \<Gamma> \<tturnstile> \<phi>"
  
definition Strong_Extended_Boolean_Propositional_Models ::
  "'a Extended_Boolean_Propositional_Formula set \<Rightarrow> 'a Extended_Boolean_Propositional_Formula \<Rightarrow> bool"  
  (infix "\<TTurnstile>\<^sub>P\<^sub>R\<^sub>O\<^sub>P" 65)
  where
...
definition Extended_Theory_Propositions :: 
  "'a Extended_Boolean_Propositional_Formula set \<Rightarrow> 'a set" ("\<^bold>\<lbrace> _ \<^bold>\<rbrace>" [50])
  where
...
lemma Truth_Lemma:
  ...
  unfolding Strong_Extended_Boolean_Propositional_Deduction_def
proof (induct \<phi>)
  case Falsum
...
next
  ...
  then show ?case
    by (metis assms
              Extended_Boolean_Propositional_Semantics.simps(4) [where \<MM>="\<^bold>\<lbrace> \<Gamma> \<^bold>\<rbrace>"]
              Formula_Maximal_Consistency 
              Formula_Maximally_Consistent_Set_verum  
              set_deduction_reflection 
              verum_Extended_Boolean_Propositional_Formula_def)
next
  case Proposition
...
next
  ...
  then show ?case
    by (metis assms
              ...
              Extended_Boolean_Propositional_Semantics.simps(2) [where \<MM>="\<^bold>\<lbrace> \<Gamma> \<^bold>\<rbrace>"]
              implication_Extended_Boolean_Propositional_Formula_def 
...
next
  ...
  then show ?case
    by (metis assms
              Extended_Boolean_Propositional_Semantics.simps(5) [where \<MM>="\<^bold>\<lbrace> \<Gamma> \<^bold>\<rbrace>"]
              ...
              Maximally_Consistent_Set_def 
              Formula_Maximally_Consistent_Set_implication 
              negation_Extended_Boolean_Propositional_Formula_def)
next
  case Conjunction
  then show ?case
    by (metis assms
              Extended_Boolean_Propositional_Semantics.simps(6) [where \<MM>="\<^bold>\<lbrace> \<Gamma> \<^bold>\<rbrace>"]
              Formula_Maximally_Consistent_Set_conjunction 
              Formula_Maximally_Consistent_Set_reflection [where \<phi>="\<bottom>" and \<Gamma>="\<Gamma>"]
              Maximally_Consistent_Set_def 
              conjunction_Extended_Boolean_Propositional_Formula_def)
next
  case Disjunction
  then show ?case
    by (metis assms 
              Extended_Boolean_Propositional_Semantics.simps(7) [where \<MM>="\<^bold>\<lbrace> \<Gamma> \<^bold>\<rbrace>"] 
              Formula_Maximally_Consistent_Set_disjunction 
              Formula_Maximally_Consistent_Set_reflection [where \<phi>="\<bottom>" and \<Gamma>="\<Gamma>"] 
              Maximally_Consistent_Set_def 
              disjunction_Extended_Boolean_Propositional_Formula_def)
next
  case (Biconditional \<phi> \<psi>)
  then show ?case
    using assms
          Extended_Boolean_Propositional_Semantics.simps(8) [where \<MM>="\<^bold>\<lbrace> \<Gamma> \<^bold>\<rbrace>"]
          Maximally_Consistent_Set_def
          Formula_Maximally_Consistent_Set_biconditional [where \<Omega>="\<Gamma>"]
          Formula_Maximally_Consistent_Set_reflection [where \<phi>="\<bottom>" and \<Gamma>="\<Gamma>"]
    unfolding biconditional_Extended_Boolean_Propositional_Formula_def
    by blast
qed

theorem Extended_Boolean_Propositional_Calculus_Strong_Soundness_And_Completeness:
...
proof -
  ...
  proof -
    ...
    from this obtain \<Gamma>' where \<Gamma>': "set \<Gamma>' \<subseteq> \<Gamma>" "\<Gamma>' :\<turnstile> \<phi>" by (simp add: set_deduction_def, blast)     
    {
      ...
      proof (induct \<Gamma>')
        case Nil
        then show ?case
          by (simp add: Extended_Boolean_Propositional_Calculus_Soundness 
                        list_deduction_def) 
      next
        case (Cons \<psi> \<Gamma>')
    ...
    thus "\<Gamma> \<TTurnstile>\<^sub>P\<^sub>R\<^sub>O\<^sub>P \<phi>"
      using Strong_Extended_Boolean_Propositional_Models_def by blast
  qed
  ...
  proof (erule contrapos_pp)
    ...
    proof -
      from \<open>~ \<Gamma> \<tturnstile>\<^sub>P\<^sub>R\<^sub>O\<^sub>P \<phi>\<close> obtain \<Omega> where \<Omega>: "\<Gamma> \<subseteq> \<Omega>" "\<phi>-MCS \<Omega>"
        by (meson Formula_Consistent_def 
                  ...
                  Strong_Extended_Boolean_Propositional_Deduction_def)
    ...
    qed
    thus "~ \<Gamma> \<TTurnstile>\<^sub>P\<^sub>R\<^sub>O\<^sub>P \<phi>"
      unfolding Strong_Extended_Boolean_Propositional_Models_def
      by simp
  qed
...
theorem Extended_Boolean_Propositional_Calculus_Soundness_And_Completeness:
  "\<turnstile>\<^sub>P\<^sub>R\<^sub>O\<^sub>P \<phi> \<equiv> \<forall>\<MM>. \<MM> \<Turnstile>\<^sub>P\<^sub>R\<^sub>O\<^sub>P \<phi>"
  by (smt Extended_Boolean_Propositional_Calculus_Strong_Soundness_And_Completeness 
          Extended_Boolean_Propositional_Calculus_Soundness 
          Strong_Extended_Boolean_Propositional_Deduction_def 
          Strong_Extended_Boolean_Propositional_Models_def 
          proves_Extended_Boolean_Propositional_Formula_def 
